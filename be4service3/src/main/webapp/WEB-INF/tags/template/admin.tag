        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
				  ...
				  <li role="separator" class="divider"></li>
				  <li><a href="<c:url value='/contratante/form'/>"><span class="glyphicon glyphicon-plus-sign"></span> Add contratante</a></li>	              
	              <li><a href="<c:url value='/contratante'/>"><span class="glyphicon glyphicon-menu-hamburger"></span> List contratante</a></li>
				  <li role="separator" class="divider"></li>
            </ul>
          </li>
        </ul>
